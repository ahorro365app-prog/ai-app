...
if (isConfigured) {
  ...
  logger.warn('[notificationsRateLimit] UPSTASH_REDIS_REST_URL y/o UPSTASH_REDIS_REST_TOKEN no están configurados. Rate limiting deshabilitado para notificaciones.');
}
